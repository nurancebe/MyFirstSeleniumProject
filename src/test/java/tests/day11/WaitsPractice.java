...
public class WaitsPractice {
    ...
    public void test2() {
        ...
        //not only present but olsa visible and we apply explicit and to use this explicit way we create object
        //of webdriver object with time
        //webdriverwait is a class it represent explisitwait in selenium
